...
* La deuxième partie consistera à **construire un rover**, et à programmer des déplacements. Le CamJam EduKit sera utilisé, qui fournit toutes les pièces nécessaires à la construction du rover: Les roues, les moteurs, et le chassis. L'activité est prévue pour être simple, peu chère (Environ 60 euros pour un CamJam EduKit, une carte programmable Raspberry Pi, et une caméra), et offrant une large liberté dans la 'personnalisation' du l'apparence du rover.  Ce sont les activités 4 à 7 ci-dessous.
